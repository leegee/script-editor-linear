...
export const sampleScript: TimelineItemProps[] = [
    ...
    { id: crypto.randomUUID(), type: "location", details: { locationId: "cottage-1" }, duration: 0 },
    ...
    { id: crypto.randomUUID(), type: "location", details: { locationId: "forest-path-1" }, duration: 0 },
    ...
    { id: crypto.randomUUID(), type: "location", details: { locationId: "cottage-inside-1" }, duration: 0 },
